...
spawn(function()
	while wait() do
		if _G.Auto_Farm_Level then
			if _G.Select_Mode_Farm == "Nhận Nhiệm Vụ" then
				pcall(function()
			...
			elseif _G.Select_Mode_Farm == "Đánh Quái Gần" then
				for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
...
local win = library:Window(" Min Gaming",[[]],"",Enum.KeyCode.RightControl)
local Main = win:Tab("Chính",[[6026568198]])
local Stats = win:Tab("Chỉ Số",[[7040410130]])
local Combat = win:Tab("Người Chơi",[[7251993295]])
local Teleport = win:Tab("Di Chuyển",[[6035190846]])
local Dungeon = win:Tab("Tập Kích",[[7044284832]])
local Shop = win:Tab("Cửa Hàng",[[6031265976]])
local DevilFruit = win:Tab("Trái Ác Quỷ",[[7044233235]])
local Misc = win:Tab("Khác",[[6034509993]])
local Race = win:Tab("Tộc V4",[[]])

Main:Seperator(" \\\\ Cày Cấp Dộ // ")

Main:Toggle("Bắt Đầu Cày",_G.Auto_Farm_Level,function(value)
	_G.Auto_Farm_Level = value
	StopTween(_G.Auto_Farm_Level)
end)

Main:Seperator(" \\\\ Cài Đặt Chế Độ  // ")

Main:Dropdown("Chọn Chế Độ", {
	"Nhận Nhiệm Vụ","Chế Độ Nhanh","Không Nhiệm Vụ","Đánh Quái Gần"
},function(value)
...
Main:Toggle("Gom Quái",_G.BringExtra,function(value)
	_G.BringExtra = value
end)
...
Main:Toggle("Gom Quái Thường",true,function(value)
...
Main:Toggle("Tránh Văng",true,function(value)
	_G.AFK = value
end)

_G.DistanceMob = 25
Main:Slider("Độ Cao",1,100,25,function(value)
	_G.DistanceMob = value
end)

 Main:Toggle('Đánh Nhanh',true,function(famobile)
...
Main:Toggle("Siêu Đánh Nhanh (Dễ Ăn Ban)",_G.FastAttackNormalSpeed,function(value)
...
Main:Toggle("Quái Tàn Hình",false,function(value)
	_G.inv = value
...
Main:Toggle("Đánh Boss",_G.Auto_Farm_Boss,function(value)
	_G.Auto_Farm_Boss = value
	StopTween(_G.Auto_Farm_Boss)
end)

Main:Toggle("Nhận Nhiệm Vụ Boss",true,function(value)
...
Main:Toggle("Đánh Tất Cả Boss",_G.Auto_Farm_All_Boss,function(value)
...
local MobKilled = Main:Label("Còn")
...
Main:Toggle("Cày Tư Lệnh Bột",_G.Auto_Cake_Prince,function(value)
	_G.Auto_Cake_Prince = value
	StopTween(_G.Auto_Cake_Prince)
end)

Main:Toggle("Tự Động Mở Cổng",_G.Auto_Open_Dough_Dungeon,function(value)
...
Main:Toggle("Cày Xương",_G.Auto_Farm_Bone,function(value)
...
Main:Seperator(" \\\\ Thông Thạo // ")

Main:Toggle("Cày Thông Thạo BF",_G.AutoFarmFruitMastery,function(value)
...
if World3 then
	...
	Main:Toggle("Tự Động Lấy Electric Claw",_G.Auto_Electric_Claw,function(value)
	...
	Main:Toggle("Tự Động Lấy Dragon Talon",_G.Auto_Dragon_Talon,function(value)
	...
	Main:Toggle("Tự Động Lấy",_G.Auto_God_Human,function(value)
		...
		while wait() do
			pcall(function()
				if game:GetService("ReplicatedStorage"):FindFirstChild("Diablo [Lv. 1750]") or game:GetService("ReplicatedStorage"):FindFirstChild("Deandre [Lv. 1750]") or game:GetService("ReplicatedStorage"):FindFirstChild("Urban [Lv. 1750]") or game:GetService("Workspace").Enemies:FindFirstChild("Diablo [Lv. 1750]") or game:GetService("Workspace").Enemies:FindFirstChild("Deandre [Lv. 1750]") or game:GetService("Workspace").Enemies:FindFirstChild("Urban [Lv. 1750]") then
					Elite_Hunter_Status:Set("Thông Báo : Có 🟢")	
				else
					Elite_Hunter_Status:Set("Thông Báo : Không 🔴")	
				end
			end)
		end
	end)
...
Main:Toggle("Cày Boss Bí Ẩn",_G.Auto_Elite_Hunter,function(value)
	_G.Auto_Elite_Hunter = value
	StopTween(_G.Auto_Elite_Hunter)
end)

Main:Toggle("Cày Boss Bí Ẩn Đổi Máy Chủ",_G.Auto_Elite_Hunter_Hop,function(value)
...
Main:Toggle("Tự Động Lấy Swan Glasses",_G.Auto_Swan_Glasses,function(value)
	_G.Auto_Swan_Glasses = value
	StopTween(_G.Auto_Swan_Glasses)
end)


Main:Toggle("Tự Động Lấy Swan Glasses Đổi Máy Chủ",_G.Auto_Swan_Glasses_Hop,function(value)
...
Main:Toggle("Tự Động Lấy Bartilo Quest",_G.Auto_Bartilo_Quest,function(value)
	_G.Auto_Bartilo_Quest = value
	StopTween(_G.Auto_Bartilo_Quest)
end)

Main:Seperator(" \\\\ tộc V2 // ")

Main:Toggle("Tự Động Lấy Tộc V2",_G.Auto_Evo_Race_V2,function(value)
...
Main:Toggle("Tự Động Lấy Serpent Bow",_G.Auto_Serpent_Bow,function(value)
	_G.Auto_Serpent_Bow = value
	StopTween(_G.Auto_Serpent_Bow)
end)

Main:Toggle("Tự Động Lấy Serpent Bow Hop",_G.Auto_Serpent_Bow_Hop,function(value)
...
Main:Toggle(" Z",true,function(a)
	_G.SkillZ = a
end)
Main:Toggle(" X",true,function(a)
	_G.SkillX = a
end)
Main:Toggle(" C",true,function(a)
	_G.SkillC = a
end)
Main:Toggle(" V",true,function(a)
	_G.SkillV = a
end)

Main:Toggle("Trắng Màn Hình",_G.WhiteScreen,function(value)
...
spawn(function()
	while task.wait() do
		pcall(function()
			if _G.Auto_Farm_Level and _G.Select_Mode_Farm == "Đánh Quái Gần" then
				for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
					if v.Name == Ms and (v.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 350 then
						v.Humanoid.WalkSpeed = 0
						v.Humanoid.JumpPower = 0
...
local SelectMaterial = Main:Dropdown("Chọn",MaterialMethod,function(value)
	_G.SelectMaterial = value
end)

Main:Toggle("Cày",_G.AutoFarmMaterial,function(t)
...
spawn(function()
	while task.wait() do
		if _G.BringNormal and _G.Select_Mode_Farm == "Đánh Quái Gần" then
			pcall(function()
				for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
...
if World2 then
	...
	Main:Toggle("Tự Động Qua Sea3",_G.Auto_Third_World,function(value)
		_G.Auto_Third_World = value
		StopTween(_G.Auto_Third_World)
	end)

	Main:Seperator("Vật Chất Kì Dị")

	Main:Toggle("Cày Vật Chất Kì Dị",_G.Auto_Farm_Ectoplasm,function(value)
	...
	Main:Toggle("Đánh Nhà Máy",_G.AutoFactory,function(value)
...
if World1 then
	...
	Main:Toggle("Tụ Động Qua Sea2",_G.Auto_New_World,function(value)
		_G.Auto_New_World = value
		StopTween(_G.Auto_New_World)
	end)
end

Main:Seperator("\\\\\  Cày Rương  //")

Main:Toggle("Cày Rương Nhanh",false,function(vu)
	_G.ChestBypass = vu
end)
...
if World2 then
	Main:Seperator("\\\\\ Đánh Law  //")

	Main:Toggle("Tự Động Đánh Law",_G.Auto_Kill_Law,function(value)
	...
	Main:Button("Vào Tập Kích Law",function()
		fireclickdetector(game:GetService("Workspace").Map.CircleIsland.RaidSummon.Button.Main.ClickDetector)
	end)
end
...
spawn(function()
	while game:GetService("RunService").Heartbeat:wait() do
		...
		ObservationLevel:Set("Điểm Haki Của Bạn : "..tostring(value))
	end
end)

Main:Toggle("Cày Điểm Haki Quan Sát",_G.AutoObservation,function(value)
...
Main:Toggle("Cày Điểm Haki Quan Sát Đổi Máy Chủ",_G.AutoObservation_Hop,function(value)
...
Combat:Seperator(" \\\\ Tiêu Diệt Người Chơi // ")
...
local SelectedPly = Combat:Dropdown("Chọn Người Chơi",Playerslist,function(value)
	_G.Select_Player = value
end)

Combat:Button("Làm Mới",function()
	Playerslist = {}
	SelectedPly:Clear()
	for i,v in pairs(game:GetService("Players"):GetChildren()) do  
...
Combat:Toggle("Quan Sát Người Chơi",_G.Spectate_Player,function(value)
...
Combat:Toggle("Di CHuyển Đến NGười CHơi",_G.Teleport_to_Player,function(value)
...
Combat:Toggle("Giết Người Chơi [Melee]",_G.Auto_Kill_Player_Melee,function(value)
...
Combat:Toggle("Giết Người Chơi [Gun]",_G.Auto_Kill_Player_Gun,function(value)
...
Combat:Toggle("Bật PvP ",false,function(value)
	_G.EnabledPvP = value
end)
...
Combat:Toggle("Chế Độ An Toàn",false,function(value)
	_G.Safe_Mode = value
...
Combat:Button("Tự Động Reset",function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SetTeam","") 
	wait()
end)

Combat:Seperator(" \\\\ Tiền Thưởng //")

Combat:Toggle("Cày Tiền Thưởng",_G.AutoFarmBounty,function(value)
...
local Pointstat = Stats:Label("Chỉ SỐ")
...
Stats:Toggle(" Melee",_G.Auto_Melee,function(value)
	_G.Auto_Melee = value
end)

Stats:Toggle(" Defense",_G.Auto_Defense,function(value)
	_G.Auto_Defense = value
end)

Stats:Toggle(" Sword",_G.Auto_Sword,function(value)
	_G.Auto_Sword = value
end)
...
Stats:Toggle(" Devil Fruits",_G.Auto_DevilFruit,function(value)
	_G.Auto_DevilFruit = value
end)

_G.PointStats = 1
Stats:Slider(" Point",1,100,1,function(value)
	_G.PointStats = value
end)
...
Main:Seperator(" Kiếm Huyền Thoại")

Main:Toggle("Tự Động Mua Kiếm Huyền Thoại",_G.AutoBuyLegendarySword,function(Value)
...
Main:Seperator(" \\\\ Lấy Saber //")

Main:Toggle("Lấy Saber",_G.AutoSaber,function(value)
	_G.AutoSaber = value
end)

Main:Toggle("Lấy Saber Đổi Máy CHủ",_G.AutoSaberHop,function(value)
...
Main:Toggle("Lấy Dragon",_G.Auto_Dragon_Trident,function(value)
	_G.Auto_Dragon_Trident = value
	StopTween(_G.Auto_Dragon_Trident)
end)


Main:Toggle("Lấy Dragon Trident Đổi Máy Chủ",_G.Auto_Dragon_Trident_Hop,function(value)
...
Main:Seperator("Lấy Soul Guitar  ")
local FM = Main:Label("")
task.spawn(function()
	while task.wait() do
		pcall(function()
...
Main:Toggle("Lấy Soul Guitar",_G.AutoNevaSoulGuitar,function(value)
...
Main:Toggle("Lấy Song Kiếm Huyền Rủa",_G.AutoCdk,function(value)
	_G.AutoCdk = value
end)
...
Main:Toggle("Mua Haki",_G.Auto_Buy_Enchancement,function(value)
...
Main:Toggle("Lấy Rengoku",_G.Auto_Rengoku,function(value)
...
if World3 then
	Main:Seperator("\\\\\Lấy  Buddy Sword  //")
	...
	Main:Toggle("Lấy Buddy Sword",_G.AutoBudySword,function(value)
...
Teleport:Toggle("Di Chuyển",false,function(value)
...
Teleport:Button("Về Sea1",function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelMain")
end)

Teleport:Button("Về Sea2",function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelDressrosa")
end)

Teleport:Button("Về Sea3",function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelZou")
end)

Dungeon:Seperator(" \\\\ Tập Kích  //")

Dungeon:Toggle("Tự Động Hoàn Thành Raid",_G.Auto_Raid,function(value)
	_G.Auto_Raid = value
...
Dungeon:Toggle("GIết Quái",_G.Kill,function(value)
	_G.Kill = value
end)
...
Dungeon:Toggle("Qua Đảo",_G.Auto_Next,function(value)
	_G.Auto_Next = value
	StopTween(_G.Auto_Next)
end)

Dungeon:Dropdown("Chọn Chips",{"Flame","Ice","Quake","Light","Dark","String","Rumble","Magma","Human: Buddha","Sand","Bird: Phoenix","Dough"},function(value)
	_G.SelectChip = value
end)
...
Dungeon:Toggle("Mua Chip",_G.AutoBuyChip,function(value)
	_G.AutoBuyChip = value
end)

Dungeon:Toggle("Vào Raid",_G.Auto_StartRaid,function(value)
...
DevilFruit:Seperator(" \\\\ Trái Ác Quỷ //")
...
DevilFruit:Toggle("Tự ĐỘng ĐỔi Fruit",_G.Random_Auto,function(value)
...
DevilFruit:Button("Đổi Fruit",function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Cousin","Buy")
end)
...
DevilFruit:Toggle("Tự ĐỘng Cất Fruit",_G.AutoStoreFruit,function(value)
...
DevilFruit:Toggle("Lụm Fruit",_G.BringFruit,function(value)
	_G.BringFruit = value
	pcall(function()
...
DevilFruit:Seperator("Định Vị")
	...
	DevilFruit:Toggle("ESP Hoa (Sea2)",false,function(a)
		FlowerESP = a
...
Shop:Button(" Geppo [ $10,000 Beli ]",function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Geppo")
end)

Shop:Button(" Buso Haki [ $25,000 Beli ]",function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Buso")
end)

Shop:Button(" Soru [ $25,000 Beli ]",function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Soru")
end)

Shop:Button(" Observation Haki [ $750,000 Beli ]",function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("KenTalk","Buy")
end)

Shop:Toggle("  Abilities", false, function(t)
	Abilities = t
...
Misc:Toggle("Vô Hạn Geppo",getgenv().InfGeppo,function(value)
...
Misc:Toggle("Vô Hạn Soru",getgenv().InfSoru,function(value)
...
Misc:Toggle("VÔ Hạn Nhảy", nil, function(State)
	Infinite = State
...
Misc:Seperator("\\\\\  Nổi Bậc  //")



Misc:Toggle("Đồ Hoạ Cao",false,function(v)
	if v then
...
Misc:Toggle("Tự Động Vào Lại Máy Chủ",true,function(value)
	_G.AutoRejoin = value
end)
...
Misc:Toggle("Đi Xuyên Tường",_G.NoClip,function()
	_G.NoClip = value
end)
...
if World3 then
    ...
    Race:Toggle("Treo Đảo Bí Ẩn",_G.dao,function(state)
    if state then
        _G.dao = true
    else
        _G.dao = false
...
Race:Toggle("Đến Đảo Bí Ẩn",false,function(value)
...
Race:Button("Lụm Bánh Răng",function()
    for _,v in next, Workspace.Map.MysticIsland:GetDescendants() do
    if v.Name:find("Part") and v.ClassName == "MeshPart" then
        ...
        Race:Button("Cày Rương Trên Đảo Bí Ẩn",function()
    ...
    Race:Button("Xoá Xương Mù",function()
...
Race:Seperator("Cửa Ải")

Race:Button("Cửa ải Của Bạn",function()
 ...
 Race:Button("Đến Clock",function()
for _,v in next, workspace:GetDescendants() do
 ...
 Race:Seperator("Auto Trial")
  Race:Toggle("Hoàn THành Tất Cả Tộc (-Cá)",_G.winv4,function(value)
 _G.winv4 = value
 StopTween(_G.winv4)
end)
spawn(function()
...
Race:Toggle("Hoàn Thành Tộc Cá",_G.SeaBeasts1,function(value)
 _G.SeaBeasts1 = value
...
Race:Seperator("Buy + Turn On V4") 
   ...
   Race:Toggle("Bật Tộc V4",_G.Auto_Farm_Bone3,function(value)
...
Race:Toggle("Mua Bánh Răng",_G.Auto_Farm_Bone4,function(value)
...
Race:Button("Di CHuyển Đến CHổ Mua Bánh Răng",function()
    Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286.35546875, 14895.3017578125, 102.62469482421875)
  Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286.35546875, 14895.3017578125, 102.62469482421875)
